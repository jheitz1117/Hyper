...
namespace Hyper.NodeServices.Extensibility.CommandModules
{
    ...
    /// This class is the default <see cref="ICommandResponse"/> type for all <see cref="ICommandModule"/> implementations if no other
    /// <see cref="ICommandResponse"/> is specified.
    /// </summary>
